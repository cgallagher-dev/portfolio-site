...
const SkillsList = () => {
  ...
  const skills = {
    ...
    "Educational Background": [
      ...
      "Core modules include Software Development for Cloud, Server-Side Web Development, Databases and Agile Methodologies.",
    ],
    "Leadership & Collaboration": [
      "As Chair of the TUS RUN-EU Student Council and Class Representative, I represent over 15,000 students in Ireland across 9 European higher education institutions. I excel in collaborative frameworks, using Agile and Jira to drive international projects across multi-disciplinary teams.",
    ],
    "Engineering Methodologies": [
      "I am a strong advocate for Test-Driven Development (TDD) and clean code architecture. My approach combines rigorous engineering discipline with creative problem-solving to build robust, maintainable software.",
    ],
  };
              ...
              >
                ...
                >
                  <div className="flex flex-col gap-2">
                    {items.map((text, idx) => (
                      <p key={idx} className="text-[0.8em] text-white text-semibold">
                        {text}
                      </p>
                    ))}
                  </div>
